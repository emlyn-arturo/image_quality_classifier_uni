...
def feature_extract(img_input):
    features = []
    features.append(sharpness(img_input))
    features.append(noise_differ_gaussian(img_input))
    features.append(noise_differ_median(img_input))
    features.append(noise_differ_noises(img_input))
    # features.append(self.hue())
    features.append(colorfulness(img_input))
...
imgs_clean = []
path = "DATABSE\\\databaserelease2\\gblur_clean"  # use your own path
...
imgs_fast = []
path_fast = "DATABSE\\\databaserelease2\\gblur_clean"  # use your own path
valid_images = [".jpg", ".bmp", ".gif", ".png", ".tga"]
